...
CREATE TABLE `gen_table`  (
  `gen_table_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编号',
  ...
  `options` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '其它生成选项',
...
CREATE TABLE `gen_table_association`  (
  `gen_table_association_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `table_association_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '表关联名称',
  `master_table_id` bigint(0) NOT NULL COMMENT '主表编号',
  `master_table_column` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '主表字段',
  `slave_table_id` bigint(0) NOT NULL COMMENT '从表编号',
  `slave_table_column` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '从表字段',
  `association_category` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'OneToOne' COMMENT '关联类别',
  `created_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `modified_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '备注',
  PRIMARY KEY (`gen_table_association_id`) USING BTREE
...
CREATE TABLE `gen_table_column`  (
  `gen_table_column_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编号',
