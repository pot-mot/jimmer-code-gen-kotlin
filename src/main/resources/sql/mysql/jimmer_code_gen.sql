...
(
    ...
    `id_generation_type`         varchar(500) NOT NULL COMMENT 'ID 生成类型',
...
(
    ...
    `display_size`      bigint       NOT NULL COMMENT '展示长度',
    ...
    `id_generation`     boolean      NOT NULL COMMENT '是否为 ID 生成',
...
(
    ...
    `id_generation_type`     varchar(500) NULL     DEFAULT NULL COMMENT 'ID 生成类型',
    `key_property`           boolean      NOT NULL COMMENT '是否为业务键属性',
    `logical_delete`         boolean      NOT NULL COMMENT '是否为逻辑删除属性',
    `id_view`                boolean      NOT NULL COMMENT '是否为 视图属性',
...
(
    ...
    `type_code`         int(0)       NOT NULL COMMENT 'JdbcType 码值',
    `raw_type`          varchar(500) NOT NULL COMMENT '字面类型',
    `display_size`      bigint       NOT NULL COMMENT '列展示长度',
