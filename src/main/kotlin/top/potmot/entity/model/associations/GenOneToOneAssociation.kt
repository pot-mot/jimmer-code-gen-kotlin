 ...
 */
@Entity
@Table(name = "gen_one_to_one_association")
interface GenOneToOneAssociation {
    /**
     * ID
     */
    @Id
    ...
    @get:Valid
    val sourceProperty: GenOneToOneSourceProperty
    ...
    @get:Valid
    val mappedProperty: GenOneToOneMappedProperty
