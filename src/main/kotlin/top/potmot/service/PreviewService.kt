...
class PreviewService(
    ...
    fun previewEntityByTable(
        ...
        return previewEntity(entityIds.toList(), withPath, dataSourceType, language)
    }
    ...
    fun previewModelSql(
        ...
        context.dataSourceType = model.dataSourceType
        context.packagePath = model.packagePath
    ...
    fun previewModelEntity(
        ...
        val entityCodes = if (model.syncConvertEntity) {
            ...
            previewEntityByTable(tableIds, model.id, withPath, model.dataSourceType, model.language, model.packagePath)
        } else {
