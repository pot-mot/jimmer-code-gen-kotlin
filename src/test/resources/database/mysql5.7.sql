...
(
    ...
    type_int_4                 INT(4),
    type_int_10                INT(10),
    type_int_zerofill          INT ZEROFILL,
    type_int_unsigned          INT UNSIGNED,
    type_int_unsigned_zerofill INT UNSIGNED ZEROFILL,
    type_int_10_unsigned       INT(10) UNSIGNED,
    type_tinyint               TINYINT COMMENT '微整数类型',
    type_tinyint_unsigned      TINYINT UNSIGNED,
    type_smallint              SMALLINT COMMENT '小整数类型',
    type_smallint_unsigned     SMALLINT UNSIGNED,
    type_mediumint             MEDIUMINT COMMENT '中整数类型',
    type_mediumint_unsigned    MEDIUMINT UNSIGNED,
    type_bigint                BIGINT COMMENT '大整数类型',
    type_bigint_unsigned       BIGINT UNSIGNED,
    type_numeric               NUMERIC COMMENT '精确数值类型',
    type_numeric_10            NUMERIC(10) COMMENT '精确数值类型(10)',
    type_numeric_10_2          NUMERIC(10, 2) COMMENT '精确数值类型(10, 2)',
    type_decimal               DECIMAL COMMENT '精确数值类型',
    type_decimal_10            DECIMAL(10) COMMENT '精确数值类型(10)',
    type_decimal_10_2          DECIMAL(10, 2) COMMENT '精确数值类型(10, 2)',
    type_decimal_unsigned      DECIMAL UNSIGNED COMMENT '精确数值类型(无符号)',
    type_dec                   DEC,
    type_fixed                 FIXED,
    type_real                  REAL COMMENT '单精度浮点数',
    type_real_unsigned         REAL UNSIGNED,
    type_float                 FLOAT COMMENT '单精度浮点数',
    type_float_unsigned        REAL UNSIGNED,
    type_double                DOUBLE COMMENT '双精度浮点数',
    type_double_unsigned       DOUBLE UNSIGNED,
    ...
    type_char                  CHAR(255),
    type_character             CHARACTER(255),
    type_character_binary      CHARACTER(255) BINARY,
    type_character_varying     CHARACTER VARYING(255),
    type_nvarchar              NVARCHAR(255),
    type_nchar                 NCHAR(255),
    type_varchar_binary        VARCHAR(255) BINARY,
    type_char_binary           CHAR(255) BINARY,
    type_nvarchar_binary       NVARCHAR(255) BINARY,
    type_nchar_binary          NCHAR(255) BINARY,
    type_text                  TEXT COMMENT '文本类型',
    type_text_binary           TEXT BINARY COMMENT '二进制文本类型',
