...
(
    ...
    type_timestamp_3_tz_array TIMESTAMP(3) WITH TIME ZONE ARRAY[10],
    type_text                 TEXT,
    ...
    type_bytea                BYTEA,
    type_binary_1000000000    BINARY(1000000000),
    type_blob                 BLOB,
    type_tinyblob             TINYBLOB,
    type_mediumblob           MEDIUMBLOB,
    type_long_blob            LONGBLOB,
    type_long_varbinary       LONGVARBINARY,
    type_clob                 CLOB,
    type_nclob                NCLOB,
