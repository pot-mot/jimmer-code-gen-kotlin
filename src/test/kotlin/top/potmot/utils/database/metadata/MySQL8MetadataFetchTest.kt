...
type_int1 1位整数类型 tinyint 3,null NULL
type_int2 2位整数类型 smallint 5,null NULL
type_int4 4位整数类型 int 10,null NULL
type_int8 8位整数类型 bigint 19,null NULL
type_int_4  int 10,null NULL
type_int_10  int 10,null NULL
type_int_zerofill  int(10) unsigned zerofill 10,null NULL
type_int_unsigned  int unsigned 10,null NULL
type_int_unsigned_zerofill  int(10) unsigned zerofill 10,null NULL
type_int_10_unsigned  int unsigned 10,null NULL
type_tinyint 微整数类型 tinyint 3,null NULL
type_tinyint_unsigned  tinyint unsigned 3,null NULL
type_smallint 小整数类型 smallint 5,null NULL
type_smallint_unsigned  smallint unsigned 5,null NULL
type_mediumint 中整数类型 mediumint 7,null NULL
type_mediumint_unsigned  mediumint unsigned 8,null NULL
type_bigint 大整数类型 bigint 19,null NULL
type_bigint_unsigned  bigint unsigned 20,null NULL
...
type_year 年类型 year 4,null NULL
...
type_timestamp 时间戳类型 timestamp 19,null NULL
type_timestamp_default  timestamp 19,null NULL DEFAULT CURRENT_TIMESTAMP 
