...
type_int2  smallint 5,null NULL
type_int4  integer 10,null NULL
type_int8  bigint 19,null NULL
type_integer  integer 10,null NULL
...
type_numeric 精确小数类型 numeric null,null NULL
type_numeric_10  numeric(10,0) 10,null NULL
type_numeric_10_2  numeric(10,2) 10,2 NULL
type_numeric_10_array 精确小数数组类型 numeric(10,0)[] 10,null NULL
type_decimal  numeric null,null NULL
type_decimal_10  numeric(10,0) 10,null NULL
type_decimal_10_2  numeric(10,2) 10,2 NULL
type_dec  numeric null,null NULL
type_dec_10  numeric(10,0) 10,null NULL
type_dec_10_2  numeric(10,2) 10,2 NULL
type_real  real 8,8 NULL
type_float 单精度浮点数 double precision 17,17 NULL
type_float4  real 8,8 NULL
type_float8  double precision 17,17 NULL
type_double 双精度浮点数 double precision 17,17 NULL
type_boolean 布尔类型 boolean 1,null NULL
type_date 日期类型 date 13,null NULL
type_time 时间类型 time without time zone 15,6 NULL
type_time_tz  time with time zone 21,6 NULL
type_time_3  time(3) without time zone 12,3 NULL
type_time_3_tz  time(3) with time zone 18,3 NULL
type_timestamp 时间戳类型 timestamp without time zone 29,6 NULL
type_timestamp_3  timestamp(3) without time zone 26,3 NULL
type_timestamp_default  timestamp without time zone 29,6 NULL DEFAULT CURRENT_TIMESTAMP 
type_timestamp_tz 时区时间戳类型 timestamp with time zone 35,6 NULL
type_timestamp_3_tz  timestamp(3) with time zone 32,3 NULL
type_text 文本类型 text 2147483647,null NULL
type_uuid  uuid 2147483647,null NULL
type_check_enum 枚举类型检查 character varying(20) 20,null NULL
type_char  character(20) 20,null NULL
type_nchar  character(20) 20,null NULL
type_json JSON数据类型 json 2147483647,null NULL
type_jsonb  jsonb 2147483647,null NULL
type_bit 位类型 bit(8) 8,null NULL
type_bytea 二进制大对象类型 bytea 2147483647,null NULL
                """.trim().split("\n"),
