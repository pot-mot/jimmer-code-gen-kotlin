...
TYPE_INT 整数类型 NUMBER(38) 38,null NULL
TYPE_INTEGER  NUMBER(38) 38,null NULL
TYPE_SMALLINT 小整数类型 NUMBER(38) 38,null NULL
TYPE_INT_NUMBER  NUMBER(10) 10,null NULL
TYPE_SMALLINT_NUMBER  NUMBER(5) 5,null NULL
TYPE_BIGINT 大整数类型 NUMBER(19) 19,null NULL
TYPE_NUMERIC  NUMBER(38) 38,null NULL
TYPE_NUMERIC_10  NUMBER(10) 10,null NULL
TYPE_NUMERIC_10_2  NUMBER(10,2) 10,2 NULL
TYPE_DECIMAL 精确小数类型 NUMBER(38) 38,null NULL
TYPE_DECIMAL_10  NUMBER(10) 10,null NULL
TYPE_DECIMAL_10_2  NUMBER(10,2) 10,2 NULL
TYPE_DEC  NUMBER(38) 38,null NULL
TYPE_REAL  FLOAT(63) 63,null NULL
TYPE_FLOAT 单精度浮点数 FLOAT(126) 126,null NULL
TYPE_BINARY_FLOAT  BINARY_FLOAT 4,null NULL
TYPE_DOUBLE_PRECISION  FLOAT(126) 126,null NULL
TYPE_BINARY_DOUBLE  BINARY_DOUBLE 8,null NULL
TYPE_DATE 日期类型 DATE 7,null NULL
TYPE_TIMESTAMP 时间戳类型 TIMESTAMP(6) 11,6 NULL
TYPE_TIMESTAMP_DEFAULT  TIMESTAMP(6) 11,6 NULL DEFAULT CURRENT_TIMESTAMP 
TYPE_TIMESTAMP_3  TIMESTAMP(3) 11,3 NULL
TYPE_TIMESTAMP_TZ 时区时间戳类型 TIMESTAMP(6) WITH TIME ZONE 13,6 NULL
TYPE_TIMESTAMP_3_TZ  TIMESTAMP(3) WITH TIME ZONE 13,3 NULL
TYPE_CHECK_ENUM 枚举类型检查 VARCHAR2(20) 20,null NULL
TYPE_CHAR  CHAR(20) 20,null NULL
TYPE_NCHAR  NCHAR(20) 20,null NULL
TYPE_VARCHAR  VARCHAR2(20) 20,null NULL
TYPE_VARCHAR2  VARCHAR2(20) 20,null NULL
TYPE_RAW_8  RAW(8) 8,null NULL
