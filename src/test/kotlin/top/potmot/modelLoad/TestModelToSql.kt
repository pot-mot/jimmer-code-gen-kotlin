...
CREATE TABLE `ENUM_TABLE` (
    ...
    `COMMON_ENUM` VARCHAR(255) NOT NULL,
    `ORDINAL_ENUM` VARCHAR(255) NOT NULL,
    `NAME_ENUM` VARCHAR(255) NOT NULL,
    PRIMARY KEY (`ID`)
)
  ENGINE = InnoDB
  CHARACTER SET = utf8mb4
...
ALTER TABLE `TREE_NODE`
    ADD CONSTRAINT `FK_TREE_NODE_TREE_NODE`
...
ALTER TABLE `M_N_SOURCE_M_N_TARGET_MAPPING`
    ADD CONSTRAINT `M_N_SOURCE_M_N_TARGET_MAPPING_S`
        FOREIGN KEY (`M_N_SOURCE_ID`)
            REFERENCES `M_N_SOURCE` (`ID`);

ALTER TABLE `M_N_SOURCE_M_N_TARGET_MAPPING`
    ADD CONSTRAINT `M_N_SOURCE_M_N_TARGET_MAPPING_T`
        FOREIGN KEY (`M_N_TARGET_ID`)
            REFERENCES `M_N_TARGET` (`ID`);

ALTER TABLE `M_O_SOURCE`
    ADD CONSTRAINT `FK_M_O_SOURCE_M_O_TARGET`
        FOREIGN KEY (`SOURCE_ID`)
            REFERENCES `M_O_TARGET` (`ID`);

ALTER TABLE `O_M_TARGET`
    ADD CONSTRAINT `FK_O_M_TARGET_O_M_SOURCE`
        FOREIGN KEY (`SOURCE_ID`)
            REFERENCES `O_M_SOURCE` (`ID`);

ALTER TABLE `O_O_SOURCE`
    ADD CONSTRAINT `FK_O_O_SOURCE_O_O_TARGET`
