...
class TestLongName(
    ...
    private val modelInput = getBaseModel()
        .let {
            it.graphData = longNameModelGraphData
            it.enums = emptyList()
            it
        }
}

private const val mysqlResult = """
...
private const val postgresResult = """
...
private const val longNameModelGraphData = """
{
    "json": {
        "cells": [
            {
                ...
                "view": "vue-shape-view",
                "shape": "TABLE_NODE",
                "id": "8278cfde-b081-4685-9769-8bc6c3c47ac3",
                "data": {
                    "table": {
                        "name": "sdaadsdassddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd",
                        "comment": "",
                        "remark": "",
                        "type": "TABLE",
                        "columns": [
                    ...
                    "items": [
                        {
                            ...
                            "id": "cc6d4116-3a3d-4e81-a084-d822db3fc61f",
                            "attrs": {
                                "COLUMN_PORT_SELECTOR": {
                                    "width": 1085
                                }
                        ...
                        {
                            "group": "COLUMN_PORT_GROUP",
                            "id": "bd1cb7b6-8f8e-4c1f-9dc2-5993896609dd",
                            "attrs": {
                                "COLUMN_PORT_SELECTOR": {
                                    "width": 1085
                                }
