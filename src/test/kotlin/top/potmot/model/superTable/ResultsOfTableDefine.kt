...
[(all-tables.sql, DROP TABLE IF EXISTS `SYS_USER`;
...
), (BIZ_PROJECT.sql, DROP TABLE IF EXISTS `BIZ_PROJECT`;
...
), (SYS_USER.sql, DROP TABLE IF EXISTS `SYS_USER`;
...
[(all-tables.sql, DROP TABLE IF EXISTS "SYS_USER" CASCADE;
...
), (BIZ_PROJECT.sql, DROP TABLE IF EXISTS "BIZ_PROJECT" CASCADE;
...
), (SYS_USER.sql, DROP TABLE IF EXISTS "SYS_USER" CASCADE;
